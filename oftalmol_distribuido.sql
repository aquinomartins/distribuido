...
--
-- Host: localhost:3306
-- Tempo de geração: 17/11/2025 às 20:37
...
(2, 52, NULL, 24, '2025-11-17 20:46:03', '2025-11-17 20:53:32', 10.00000000, 'ended'),
(3, 2, NULL, 24, '2025-11-17 20:53:54', '2025-11-17 20:56:01', 0.00000000, 'ended'),
(4, 2, NULL, 24, '2025-11-17 20:56:00', '2025-11-17 20:57:00', 1.00000000, 'ended'),
(5, 2, NULL, 19, '2025-11-17 21:43:44', '2025-11-17 21:46:00', 10.00000000, 'ended'),
(6, 2, NULL, 26, '2025-11-17 22:07:00', '2025-11-17 22:09:00', 10.00000000, 'ended'),
(7, 2, NULL, NULL, '2025-11-17 23:23:00', '2025-11-17 23:57:00', 1.00000000, 'running');

-- --------------------------------------------------------

--
-- Estrutura para tabela `auction_profiles`
--
...
--
-- Despejando dados para a tabela `auction_profiles`
--

INSERT INTO `auction_profiles` (`auction_id`, `title`, `description`, `image_url`, `created_at`, `updated_at`) VALUES
(7, 'Obra', 'a', NULL, '2025-11-17 23:23:26', '2025-11-17 23:23:26');
...
(61, 40, 2, '2025-11-17 17:28:40', '2025-11-17 20:28:34', '2025-11-17 20:28:40'),
(62, 40, 9, '2025-11-17 17:29:18', '2025-11-17 20:28:34', '2025-11-17 20:29:18'),
(63, 41, 2, '2025-11-17 17:30:16', '2025-11-17 20:30:07', '2025-11-17 20:30:16'),
(64, 41, 9, '2025-11-17 17:30:35', '2025-11-17 20:30:07', '2025-11-17 20:30:35'),
(65, 42, 2, '2025-11-17 17:31:26', '2025-11-17 20:31:11', '2025-11-17 20:31:26'),
(66, 42, 9, '2025-11-17 17:31:21', '2025-11-17 20:31:11', '2025-11-17 20:31:21'),
(67, 43, 59, '2025-11-17 17:55:10', '2025-11-17 20:55:04', '2025-11-17 20:55:10');
...
(40, 2, 'bitcoin', 'buy', 1.00000000, 111.00000000, 9, '{\"asset\": \"bitcoin\", \"action\": \"buy\", \"amount\": 1, \"total_brl\": 111, \"counterparty_id\": 9}', '1d0ac07372253e2be19cf97c1cbf7591', 'executed', NULL, '2025-11-17 20:28:34', '2025-11-17 17:29:18', '2025-11-17 17:29:18'),
(41, 2, 'bitcoin', 'sell', 10.00000000, 130.00000000, 9, '{\"asset\": \"bitcoin\", \"action\": \"sell\", \"amount\": 10, \"total_brl\": 130, \"counterparty_id\": 9}', '745f627e9ae2e3b3a0e3a11bb5295fbc', 'executed', NULL, '2025-11-17 20:30:07', '2025-11-17 17:30:35', '2025-11-17 17:30:35'),
(42, 2, 'bitcoin', 'sell', 10.00000000, 10.00000000, 9, '{\"asset\": \"bitcoin\", \"action\": \"sell\", \"amount\": 10, \"total_brl\": 10, \"counterparty_id\": 9}', '0f38f2bf8643249c910829a42b8b606a', 'executed', NULL, '2025-11-17 20:31:11', '2025-11-17 17:31:26', '2025-11-17 17:31:26'),
(43, 59, 'brl', 'deposit', 13.00000000, NULL, NULL, '{\"asset\": \"brl\", \"action\": \"deposit\", \"amount\": 13, \"total_brl\": null, \"counterparty_id\": null}', 'ccc9716bbd7bc6762caa40ed4ab488c3', 'executed', NULL, '2025-11-17 20:55:04', '2025-11-17 17:55:10', '2025-11-17 17:55:10');

-- --------------------------------------------------------

--
-- Estrutura para tabela `special_asset_transfers`
--

CREATE TABLE `special_asset_transfers` (
  `id` bigint NOT NULL,
...
--
-- Despejando dados para a tabela `special_asset_transfers`
--

INSERT INTO `special_asset_transfers` (`id`, `request_id`, `asset`, `amount`, `total_brl`, `from_user_id`, `to_user_id`, `created_at`) VALUES
(1, 40, 'brl', 111.00000000, 111.00000000, 2, 9, '2025-11-17 20:29:18'),
(2, 41, 'brl', 130.00000000, 130.00000000, 9, 2, '2025-11-17 20:30:35'),
(3, 42, 'brl', 10.00000000, 10.00000000, 9, 2, '2025-11-17 20:31:26');
...
(2, 48.00000000, 2, 4029.00, 0.00000000, '2025-11-17 20:31:26'),
(9, 55.00000000, 6, 38.00, 5.00000000, '2025-11-17 20:31:26'),
...
(59, 200.00000000, 0, 13.00, 0.00000000, '2025-11-17 20:55:10');
...
--
-- Índices de tabela `auction_profiles`
--
ALTER TABLE `auction_profiles`
...
--
-- Índices de tabela `special_asset_transfers`
--
ALTER TABLE `special_asset_transfers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_request` (`request_id`),
  ADD KEY `idx_transfer_from` (`from_user_id`),
  ADD KEY `idx_transfer_to` (`to_user_id`);
...
--
-- AUTO_INCREMENT de tabela `special_asset_transfers`
--
ALTER TABLE `special_asset_transfers`
...
--
-- Restrições para tabelas `auction_profiles`
--
ALTER TABLE `auction_profiles`
  ADD CONSTRAINT `auction_profiles_ibfk_1` FOREIGN KEY (`auction_id`) REFERENCES `auctions` (`id`);
...
--
-- Restrições para tabelas `special_asset_transfers`
--
ALTER TABLE `special_asset_transfers`
  ADD CONSTRAINT `fk_special_transfer_from` FOREIGN KEY (`from_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_special_transfer_request` FOREIGN KEY (`request_id`) REFERENCES `special_asset_action_requests` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_special_transfer_to` FOREIGN KEY (`to_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
